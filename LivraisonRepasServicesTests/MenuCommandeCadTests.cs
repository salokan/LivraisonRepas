...
//        {
//            // Arrange
//            CommandesCad restaurantsCad = new CommandesCad();
//            CommandesComposite restaurant = new CommandesComposite { NomRestaurants = "restaurantTest" };
//            int idRestaurant = 0;
...
//        [TestMethod]
//        public void GetMenusCommandeByCommandeTest()
//        {
//            // Arrange
//            CommandesCad restaurantsCad = new CommandesCad();
//            CommandesComposite restaurant = new CommandesComposite { NomRestaurants = "restaurantTest" };
...
//            // Act
//            List<MenuRestaurantComposite> menuRestaurantList = menuRestaurantCad.GetMenuRestaurantByRestaurant(idRestaurant);
...
//        [TestMethod]
//        public void GetMenuCommandeTest()
//        {
//            // Arrange
//            CommandesCad restaurantsCad = new CommandesCad();
//            CommandesComposite restaurant = new CommandesComposite { NomRestaurants = "restaurantTest" };
...
//            MenuRestaurantCad menuRestaurantCad = new MenuRestaurantCad();
//            CommandesComposite menuRestaurant = new CommandesComposite { IdRestaurant = idRestaurant, IdMenu = idMenu };
//            int idMenuRestaurant = 0;
//            menuRestaurantCad.AddMenuRestaurant(menuRestaurant);
...
//            MenuRestaurantCad menuCommandeCad = new MenuRestaurantCad();
//            MenuRestaurantComposite menuRestaurant = new MenuRestaurantComposite { IdRestaurant = idRestaurant, IdMenu = idMenu };
//            int idMenuRestaurant = 0;
//            menuRestaurantCad.AddMenuRestaurant(menuRestaurant);
